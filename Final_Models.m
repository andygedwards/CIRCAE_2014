...
param.Kpcmax = 0.11662; % WT value from Bondarenko 2010
param.koCa = 0.005; % RyR on rate scaling constant
param.kiCa = 0.22; % RyR inactivation scaling constant
param.kim = 1.2; % RyR recovery from inactivation
param.kom = 0.06; % RyR closing rate
param.MaxSR = 18; % Upper limit for scaling of RyR luminal Ca sensitivity
param.MinSR = 1; % Lower limit for scaling of RyR luminal Ca sensitivity
param.Gtof = 0.4067; % maximal Ito,f conductance
param.GKss = 0.05; % maximal IKss conductance  
param.GKur = 0.16; % maximal IKur conductance
param.GK1  = 0.2938; % maximal IK1 conductance
param.dPRyR = 0.02; % ICaL RyR dependence
...
% Only Tg-specific changes commented

params.beta = 0.30;
params.vNCXmax=2.0*2.5; % 2.5 fold scaling of Tg maximal NCX
params.SERCAVmax = 0.2*0.7; % 30% reduction in Tg SERCA Vmax 
params.kmr = 3500;
params.kmf = 0.6;
params.GCa = 0.1729*1.2; % 20% increase in maximal ICaL conductance in Tg
params.SRsens = 300;
params.KmNai = 16650;
params.Kpcmax = 0.11662*0.75; % 25% reduction in Ca-dependent ICaL inactivation parameter
params.koCa = 0.005;
params.kiCa = 0.22;
params.kim = 1.2;
params.kom = 0.06;
...
params.Gtof = 0.4067*0.65; % 35% reduction in Ito,f conductance (Wagner 2009)  
params.GKss = 0.05;   
params.GKur = 0.16;
params.GK1  = 0.2938*0.5; % 50% reduction in maximal IK1 conductance in Tg (Wagner 2009)
params.dPRyR = 0.02;
...
% Only Iso-induced changes commented (Tg parameters also present) 

params2.beta = 0.30;
params2.vNCXmax=2.0*2.5;
params2.SERCAVmax = 0.2*0.7;
params2.kmr = 3500*0.55; % 45% increase in SERCA affinity for luminal Ca (while maintaining thermodynamic limit)
params2.kmf = 0.6*0.55; % 45% increase in SERCA affinity for cytosolic Ca (while maintaining thermodynamic limit)
params2.GCa = 0.1729*1.2*2.0; % 2 fold increase in ICaL maximal conductance due to Iso
params2.SRsens = 300;
params2.KmNai = 16650*0.72; % increased sensitivity of INaK to Nai due to Iso
params2.Kpcmax = 0.11662*0.75; 
params2.koCa = 0.005;
params2.kiCa = 0.22;
params2.kim = 1.2;
params2.kom = 0.06;
params2.MaxSR = 10;
params2.MinSR = 1;
params2.kleak = (0.1e-5)*5; 
params2.Gtof = 0.4067*0.65;   
params2.GKss = 0.05;   
params2.GKur = 0.160*1.20; % 20% increase in IKur maximal conductance
params2.GK1  = 0.2938*0.5; 
params2.dPRyR = 0.02;
params2.P2a5 = 7.8;
...
params2.alphaV = 22; % Iso-induced leftward shifts (7 mV) in ICaL gating
params2.betaV = 22; % Iso-induced leftward shifts (7 mV) in ICaL gating
 
[T3,S3,loginfo3,x3,ioninfo3] = pacemodel(@Final_BondGrandiINa_SBSERCA,1000,50,params2,TG_x0,'ioninfo');
...
varcols = [37,33,34,35,36]; % [mV, Cai, Cadyad, Cajsr, CaSR]
colors = {'b','r','g','k','m','c'};
