...
for i = 9:12
    VClampAmps(end+1:end+length(S3{i}(:,37))-1) = S3{i}(2:end,37);
    VClampTimes(end+1:end+length(T3{i})-1) = T3{i}(2:end)+((i-1)*1000);
end

clearvars -except VClampAmps VClampTimes

load TG_x0

params2.VClampAmp = VClampAmps(2:end)';
params2.VClampTimes = VClampTimes(2:end)';
...
% 
[T4,S4,loginfo4,x4,ioninfo4] = pacemodel(@Final_BondGrandiINa_SBSERCA,12000,1,params2,TG_x0,'ioninfo');